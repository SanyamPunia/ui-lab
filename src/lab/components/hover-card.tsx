  ...
  return (
    ...
    >
      <button
        ...
        className="rounded-[4px] font-medium whitespace-nowrap text-foreground underline decoration-foreground/25 decoration-1 underline-offset-4 outline-none transition-[text-decoration-color] duration-150 ease-out hover:decoration-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground aria-expanded:decoration-foreground"
      >
        {profile.handle}
      </button>
...
function FollowButton({
  ...
  return (
    <button
      ...
      onClick={onToggle}
      className={cn(
        "grid h-9 rounded-full px-4 text-[14px] font-medium outline-none transition-[scale,background-color,color,box-shadow] duration-150 ease-out focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground active:scale-[0.96] motion-reduce:transition-[background-color,color,box-shadow]",
        following
