            ...
            {files.map((file, i) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "group relative touch-manipulation px-3 font-mono text-[13px] outline-none transition-[color] duration-150 ease-out select-none focus-visible:outline-2 focus-visible:-outline-offset-4 focus-visible:outline-foreground",
        ...
        {files.map((file, i) => {
          ...
          return (
            <div
              ...
              inert={!selected}
              className={cn(
                "absolute inset-0 overflow-auto overscroll-contain outline-none focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-foreground",
...
function CopyCode({ value }: { value: string }) {
  ...
  return (
    <button
      ...
      className={cn(
        "relative flex h-8 touch-manipulation items-center gap-1.5 rounded-lg px-2.5 text-[13px] text-muted outline-none transition-[scale,color,background-color] duration-150 ease-out select-none hover:bg-background hover:text-foreground focus-visible:outline-2 focus-visible:outline-foreground active:scale-[0.96] motion-reduce:transition-[color,background-color]",
