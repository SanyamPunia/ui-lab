        ...
        <div className="grid grid-cols-6 gap-2">
          {plan.map((delay, i) => (
            <button
              ...
              onClick={() => ripple(i)}
              className={cn(
                "flex h-12 flex-col justify-between rounded-lg bg-surface p-2 text-left outline-none transition-[scale,box-shadow] duration-150 ease-out focus-visible:outline-2 focus-visible:outline-foreground active:scale-[0.96]",
        ...
        {options.map((o) => (
          <button
            ...
            className={cn(
              ...
              "h-8 min-w-0 truncate rounded-[8px] px-1 text-[13px] font-medium outline-none transition-[color,background-color,scale] duration-150 ease-out focus-visible:outline-2 focus-visible:outline-foreground active:scale-[0.96]",
