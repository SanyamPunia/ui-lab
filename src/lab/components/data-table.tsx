                ...
                return (
                  ...
                  >
                    <button
                      ...
                      className={cn(
                        "inline-flex h-8 items-center gap-1 rounded-lg px-2 text-[13px] font-medium whitespace-nowrap outline-none select-none",
  ...
  return (
    ...
    <label className="-m-2.5 grid size-9 cursor-pointer place-items-center">
      <input
        ...
        aria-label={label}
        className={cn(
          "peer col-start-1 row-start-1 size-4 cursor-pointer appearance-none rounded-[5px] bg-background shadow-[inset_0_0_0_1.5px_var(--border)] outline-none disabled:cursor-default disabled:opacity-50",
...
function BarButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex h-9 items-center gap-1.5 rounded-full px-3 font-medium outline-none select-none transition-[scale,background-color] duration-150 ease-out hover:bg-background/15 focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-background active:scale-[0.96] motion-reduce:transition-[background-color]"
    >
      {children}
    </button>
  );
  ...
  return (
    <div className="flex w-[600px] max-w-full flex-col items-end gap-2">
      ...
      <button
        ...
        inert={full}
        className={cn(
          "h-9 rounded-full px-3 text-sm text-muted outline-none select-none transition-[opacity,scale,color,filter] duration-150 ease-out hover:text-foreground focus-visible:outline-2 focus-visible:outline-foreground active:scale-[0.96] motion-reduce:transition-[opacity,color]",
