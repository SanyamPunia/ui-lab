  ...
  return (
    <div className="flex w-80 items-center gap-2 text-muted">
      <motion.button
        ...
        style={{ x: lowIconX }}
        className="relative flex size-8 shrink-0 items-center justify-center rounded-full outline-none transition-[scale,color] duration-150 ease-out hover:text-foreground focus-visible:outline-2 focus-visible:outline-foreground active:scale-[0.96]"
      >
      ...
      <div
        ...
        className="group flex h-8 flex-1 cursor-pointer touch-none items-center rounded-full outline-none focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-foreground"
        onPointerDown={(e) => {
