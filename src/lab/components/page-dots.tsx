...
function Dot({
  ...
  return (
    <motion.button
      ...
      className="group absolute inset-y-0 -ml-[3px] box-content flex touch-manipulation items-center rounded-full px-[3px] outline-none focus-visible:outline-2 focus-visible:outline-foreground"
      style={{ left, width }}
    >
