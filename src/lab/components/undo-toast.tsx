          ...
          {empty && (
            ...
            >
              ...
              <button
                type="button"
                onClick={() => setGone([])}
                className="h-9 touch-manipulation rounded-full bg-background px-4 text-sm font-medium text-foreground shadow-raised outline-none transition-[scale] duration-150 ease-out select-none focus-visible:outline-2 focus-visible:outline-foreground active:scale-[0.96] motion-reduce:transition-none"
              >
                Restore demo
              </button>
            </motion.div>
          ...
          {pending.length > 0 && (
            ...
            >
              ...
              <button
                ...
                className="h-9 shrink-0 touch-manipulation rounded-full px-3.5 text-[15px] font-semibold outline-none transition-[scale,background-color] duration-150 ease-out select-none hover:bg-background/15 focus-visible:outline-2 focus-visible:outline-background active:scale-[0.96] motion-reduce:transition-[background-color]"
              >
                Undo
              </button>
            </motion.div>
