    ...
    >
      ...
      >
        <textarea
          ...
          className="max-h-[120px] min-h-10 flex-1 resize-none rounded-[20px] bg-surface px-4 py-2.5 text-[15px] leading-5 text-foreground outline-hidden [field-sizing:content] placeholder:text-muted focus-visible:outline-2 focus-visible:outline-solid focus-visible:outline-offset-0 focus-visible:outline-foreground"
        />
        <button
          type="submit"
          aria-label="Send"
