  ...
  return (
    ...
    >
      ...
      <div ref={scroller} className="h-full overflow-y-auto overscroll-contain">
        ...
        <article className="px-6 pt-5 pb-16 text-[15px] leading-relaxed text-pretty text-muted">
          <h2
            ref={heading}
            tabIndex={-1}
            className="rounded-sm text-xl font-semibold text-balance text-foreground outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground"
          >
            {title}
          </h2>
      ...
      <button
        ...
        className={cn(
          "absolute right-4 bottom-4 flex size-10 touch-manipulation items-center justify-center rounded-full bg-background text-foreground shadow-raised outline-none select-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground active:scale-[0.96]",
