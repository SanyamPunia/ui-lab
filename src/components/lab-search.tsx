      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="relative w-full max-w-64">
          ...
          <input
            ...
            spellCheck={false}
            autoComplete="off"
            className="h-9 w-full rounded-full bg-surface pr-9 pl-9 text-sm text-foreground shadow-raised outline-none placeholder:text-muted focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground [&::-webkit-search-cancel-button]:appearance-none"
          />
